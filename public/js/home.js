...
document.querySelector('form').addEventListener('submit',function(e){
   ...
   async  function Register(){
      let signup_api="http://localhost:5555/signup";
...
let login_api='http://localhost:5555/signin';
...
if(data.message=='Either email or password is incorrect')
{
...
document.getElementById('search_search').addEventListener('click',()=>{
    ...
    let search_url=`http://localhost:5555/Search?search=${val}`
    sch()
   async function sch()
    {
